...
get_header(); ?>
    <main>
                ...
                <div class="w-full px-2">
                        ...
                        if ($enQuery->have_posts()) {
                           while ($enQuery->have_posts()) {
                                ...
                                ?>
                                <div class="rounded-xl overflow-hidden shadow-lg shadow-gray-300 md:flex p-8">
                                    <div class="w-full sm:w-1/2 lg:w-1/4">
                                        <img src="<?php echo $thumbEncarte; ?>" class="w-full" alt="">
                                    </div>
                                    <div class="w-full sm:w-1/2 lg:w-3/4 md:px-8 py-2 md:pt-8 md:pb-4 uppercase">
                                        <h3 class="text-4xl text-red-700 font-medium uppercase pb-4">ENCARTE</h3>
        ...
        <section class="py-8">
            <div class="container mx-auto px-4">
                <h3 class="text-4xl text-red-700 text-center font-medium uppercase pb-4">
                        ...
                        <div class="w-full sm:w-1/2 md:w-1/3 xl:w-1/4 px-2 py-4">
                            <div class="rounded-xl overflow-hidden shadow-lg shadow-gray-300">
                                ...
                                <div class="px-4 py-4 uppercase">
                                    <h3 class="text-2xl text-red-700 font-medium pb-2">LÂMINA</h3>
                                    <h4 class="text-sm font-medium text-gray-600 pb-2">Oswaldo Cruz, Pilares, Vila da Penha e Inhaúma</h4>
                                    <div class="flex gap-x-4">
                                    <?php 
                                        if (get_field('pdf')) {
                                            $encarteArquivo = get_field('pdf');
                                            ?>
                                            <a href="<?php echo $encarteArquivo; ?>" class="block w-1/2" target="_blank"><button class="bg-red-700 text-gray-100 hover:bg-red-800 hover:text-gray-100 font-medium rounded-full my-4 py-2 px-6 text-sm mx-auto uppercase">DOWNLOAD</button></a>
                                            <?php
                                        }
                                        ?>
                                        <a href="<?php echo get_the_permalink(); ?>" class="block w-1/2">
                                            <button class="bg-red-700 text-gray-100 hover:bg-red-800 hover:text-gray-100 font-medium rounded-full my-4 py-2 px-6 text-sm mx-auto uppercase">VER LÂMINA</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
