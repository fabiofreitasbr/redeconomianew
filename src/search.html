...
<body>
    <div class="bg-neutral-200">
        <div class="container mx-auto px-4 flex justify-between items-center">
            <div class="font-bold py-3 px-5 bg-pink md:text-lg flex text-red-700">
                <div class="px-2">
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5" viewBox="0 0 23.811 23.81">
                            <path id="facebook"
                ...
                <div class="px-2">
                    <a href="">
                        ...
                        <svg id="instagram" xmlns="http://www.w3.org/2000/svg" class="h-5" viewBox="0 0 23.763 23.766">
                ...
                <div class="px-2">
                    <a href="">
                        <svg id="youtube" xmlns="http://www.w3.org/2000/svg" class="h-5" viewBox="0 0 32.831 23">
            ...
            <div class="font-bold py-3 px-5 bg-pink md:text-sm flex text-red-700 uppercase">
                <a href="">
                    <div class="px-2 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5" viewBox="0 0 28.812 23">
                            <path id="mail"
                ...
                <a href="">
                    <div class="px-2 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5" viewBox="0 0 26.537 26.34">
    ...
    <header class="w-full bg-red-700 text-white py-2">
        <div class="container mx-auto px-4 flex items-center justify-between">
            <div class="flex md:hidden px-4 justify-start items-center">
                <a id="mobile-call">
                    <i class="fa-solid fa-bars text-pink text-2xl">
                    </i>
                </a>
            </div>
            ...
            <div class="flex w-6/12 justify-center hidden md:flex">
                <div id="search_widget" class="w-full relative" data-search-controller-url="/pesquisa">
                    <form method="get" action="/search.html">
                        ...
                        <input
                            ...
                            name="s" placeholder="FAÇA A SUA BUSCA" type="text" autocomplete="off">
                            ...
                            <div class="relative bg-white rounded-lg shadow">
                                ...
                                <div class="px-3 py-1 space-y-6 text-black">
                                    <div class="header-search-autosuggest active">
                                        <div class="content-autosuggest text-xs font-reading" id="autosuggest-insert">
                                            <div class="mb-2">
                                                <h3 class="uppercase text-red-700 font-bold py-2">
                                                    Páginas
                                                </h3>
                                                <div class="grid grid-cols-3 gap-1 text-xs uppercase " id="autosuggest-page">
                                                    <div>
                                                        <a href="https://www.redeconomia.com.br" class="bg-red-700 text-white rounded hover:bg-red-800 p-2 block">
                                                            <i class="fas fa-info-circle px-1">
                                                            </i>
                                                            Início
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <a href="https://www.redeconomia.com.br/sobre/" class="bg-red-700 text-white rounded hover:bg-red-800 p-2 block">
                                                            <i class="fas fa-info-circle px-1">
                                                            </i>
                                                            Sobre
                                                        </a>
                                                    ...
                                                    <div>
                                                        <a href="https://www.redeconomia.com.br/ofertas/" class="bg-red-700 text-white rounded hover:bg-red-800 p-2 block">
                                                            <i class="fas fa-shopping-cart px-1">
                                                            </i>
                                                            Ofertas
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <a href="https://www.redeconomia.com.br/lojas/" class="bg-red-700 text-white rounded hover:bg-red-800 p-2 block">
                                                            <i class="fas fa-store px-1">
                                                            </i>
                                                            Lojas
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <a href="https://www.redeconomia.com.br/sac/" class="bg-red-700 text-white rounded hover:bg-red-800 p-2 block">
                                                            <i class="fas fa-headset px-1">
                                                            </i>
                                                            Sac
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <a href="https://www.redeconomia.com.br/trabalhe-conosco/" class="bg-red-700 text-white rounded hover:bg-red-800 p-2 block">
                                                            <i class="fas fa-users px-1">
                                                            </i>
                                                            Trabalhe Conosco
                                                        </a>
                                                    </div>
                                                    <div>
                                                        <a href="https://www.redeconomia.com.br/promocoes/" class="bg-red-700 text-white rounded hover:bg-red-800 p-2 block">
                                                            <i class="fas fa-bullhorn px-1">
                                                            </i>
                                                            Promoções
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="grid grid-cols-2 gap-2 text-sm" id="autosuggest-tip">
                                                    <div class="bg-gray-100 hover:bg-gray-200 rounded-lg overflow-hidden">
                                                        <a href="https://www.redeconomia.com.br/dicas/67755-2/">
                                                            <div class="flex h-full">
                                                                <div class="w-2/6">
                                                                    <div class="w-full h-full bg-center bg-cover" style="background-image: url('https://www.redeconomia.com.br/wp-content/uploads/2022/02/WhatsApp-Image-2022-01-21-at-11.43.06.jpeg');"></div>
                                                                </div>
                                                                <div class="w-4/6 p-3">
                                                                    <h4>
                                                    ...
                                                    <div class="bg-gray-100 hover:bg-gray-200 rounded-lg overflow-hidden">
                                                        <a
                                                            href="https://www.redeconomia.com.br/dicas/redeconomia-na-cozinha-receita-de-salada-tropical/">
                                                            <div class="flex h-full">
                                                                <div class="w-2/6">
                                                                    <div class="w-full h-full bg-center bg-cover" style="background-image: url('https://www.redeconomia.com.br/wp-content/uploads/2022/02/8a8803a5-86d6-471d-84d1-2cd7ed1bc337.jpeg');"></div>
                                                                </div>
                                                                <div class="w-4/6 p-3">
                                                                    <h4>
                                                                        Redeconomia na cozinha – Receita de Salada Tropical
                                                                    </h4>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    ...
                                                    <div class="bg-gray-100 hover:bg-gray-200 rounded-lg overflow-hidden">
                                                        <a
                                                            ...
                                                            <div class="flex h-full">
                                                                <div class="w-2/6">
                                                                    <div class="w-full h-full bg-center bg-cover" style="background-image: url('https://www.redeconomia.com.br/wp-content/uploads/2022/02/thumb_Youtube_1280x720px_Cozinhando_redeconomia.jpeg');"></div>
                                                                </div>
                                                                <div class="w-4/6 p-3">
                                                                    <h4>
                                                    ...
                                                    <div class="bg-gray-100 hover:bg-gray-200 rounded-lg overflow-hidden">
                                                        <a
                                                            ...
                                                            <div class="flex h-full">
                                                                <div class="w-2/6">
                                                                    <div class="w-full h-full bg-center bg-cover" style="background-image: url('https://www.redeconomia.com.br/wp-content/uploads/2022/02/thumb_Youtube_1280x720px_Cozinhando_redeconomia.png');"></div>
                                                                </div>
                                                                <div class="w-4/6 p-3">
                                                                    <h4>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="grid grid-cols-2 gap-2" id="autosuggest-store">
                                                    <div class="bg-gray-100 hover:bg-gray-200 p-2 rounded-lg">
                                                        <a href="https://www.redeconomia.com.br/lojas/?loja=64967">
                                                            <div class="flex items-center">
                                                                <div class="px-3 text-red-700">
                                                                    <i class="fas fa-map-marker-alt fa-2x">
                                                                    </i>
                                                                </div>
                                                                <div>
                                                                    <h4 class="text-red-700 uppercase text-base">
                                                                        Campo Grande
                                                                    </h4>
                                                                    <p class="text-xs">
                                                                        RUA CASA NOVA , Nº11
                                                    ...
                                                    <div class="bg-gray-100 hover:bg-gray-200 p-2 rounded-lg">
                                                        <a href="https://www.redeconomia.com.br/lojas/?loja=64966">
                                                            <div class="flex items-center">
                                                                <div class="px-3 text-red-700">
                                                                    <i class="fas fa-map-marker-alt fa-2x">
                                                                    </i>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-xs">
                                                                        Rua das Orquídeas, nº 878 Quadra: 02 Lote: 02 A
                                                                        Bairro: Itaipuaçu - Maricá
                                                                        Tel: (21) 2636-6894
                                                                    </p>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="bg-gray-100 hover:bg-gray-200 p-2 rounded-lg">
                                                        <a href="https://www.redeconomia.com.br/lojas/?loja=60299">
                                                            <div class="flex items-center">
                                                                <div class="px-3 text-red-700">
                                                                    <i class="fas fa-map-marker-alt fa-2x">
                                                                    </i>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-xs">
                                                                        RUA LEOPOLDO FROES , 31 – Santa Teresa
                                                                        Tel: 3852-6001 / 2509-8121 / 3852-7452
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    ...
                                                    <div class="bg-gray-100 hover:bg-gray-200 p-2 rounded-lg">
                                                        <a href="https://www.redeconomia.com.br/lojas/?loja=60298">
                                                            <div class="flex items-center">
                                                                <div class="px-3 text-red-700">
                                                                    <i class="fas fa-map-marker-alt fa-2x">
                                                                    </i>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="text-xs">
                                                                        RUA DE CATUMBI , 112 / 114 / SUPL .RUA CHICHORRO, 07 – Catumbi
                                                                        Tel: 3507-2866 / 2273-4053
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </a>
            ...
            <div class="flex items-center md:w-3/12 justify-end">
                <div id="_desktop_user_info">
                    <div class="user-info">
                        <a class="mx-4 justify-center items-center hidden md:flex">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="31.926" height="34.311"
                ...
                <div id="mx-2 relative _desktop_cart">
                    <div class=" relative active" data-refresh-url="/module/ps_shoppingcart/ajax">
                        <a class="mx-4 justify-center items-center hidden md:flex" href="/carrinho?action=show">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" width="31.819" height="27.812"
        ...
        <div class="menu js-top-menu" id="_desktop_top_menu">
            <nav class="">
                <div class="container mx-auto px-4 py-2 uppercase">
                    <ul class=" z-10 top-menu flex justify-between items-center text-xs lg:text-lg" id="top-menu"
                        data-depth="0">
                        <li class="dropdown-item dropdown mx-4 category" id="category-12">
                            <a class=" py-2  flex items-center justify-center" href="index.html" data-depth="0">
                                Home
                            </a>
                        </li>
                        <li class="dropdown-item dropdown mx-4 category" id="category-12">
                            <a class=" py-2  flex items-center justify-center" href="sobre.html" data-depth="0">
                                A Redeconomia
                            </a>
                        </li>
                        <li class="dropdown-item dropdown mx-4 category" id="category-12">
                            <a class=" py-2  flex items-center justify-center" href="encarte.html" data-depth="0">
                                Encartes
                            </a>
                        </li>
                        <li class="dropdown-item dropdown mx-4 category" id="category-12">
                            <a class=" py-2  flex items-center justify-center" href="lojas.html" data-depth="0">
                                Lojas
                            </a>
                        </li>
                        <li class="dropdown-item dropdown mx-4 category" id="category-12">
                            <a class=" py-2  flex items-center justify-center" href="dicas.html" data-depth="0">
                                Dicas & Receitas
                            </a>
                        </li>
                        <li class="dropdown-item dropdown mx-4 category" id="category-12">
                            <a class=" py-2  flex items-center justify-center" href="trabalhe-conosco.html" data-depth="0">
                                Trabalhe Conosco
                            </a>
                        </li>
                        <li class="dropdown-item dropdown mx-4 category" id="category-12">
                            <a class=" py-2  flex items-center justify-center" href="contato.html" data-depth="0">
                                Contato
                            </a>
                        </li>
                        <li class="dropdown-item dropdown mx-4 category" id="category-12">
                            <a class=" py-2  flex items-center justify-center" href="promocoes.html" data-depth="0">
                                Promoções
                            </a>
                        </li>
                    </ul>
    ...
    <div class="bg-gray-200 py-6">
        <div class="container mx-auto px-4">
            <h1 class="text-red-700 text-3xl font-medium uppercase">CONTATO</h1>
        </div>
    </div>
    <main>
        <section class="py-8">
                    ...
                    <div class="w-1/2">
                        ...
                        <div class="bg-white border-red-700 border-2 rounded-xl py-2 px-6 my-3">
                            <div class="flex flex-col w-2/3 mx-auto uppercase">
                                ...
                                <button
                                    class="bg-red-700 text-gray-100 hover:bg-red-800 hover:text-gray-100 font-medium rounded-full my-4 py-2 px-10 block text-base mx-auto uppercase">ver
                                    lojas</button>
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-x-16">
                ...
                <div class="">
                    ...
                    <ul class="font-reading">
                        ...
                        <li class="py-1"><a href="">A Redeconomia</a></li>
                        <li class="py-1"><a href="">Encarte</a></li>
                        <li class="py-1"><a href="">Lojas</a></li>
                        <li class="py-1"><a href="">Dicas & Receitas</a></li>
                        <li class="py-1"><a href="">Trabalhe Conosco</a></li>
                        <li class="py-1"><a href="">Contato</a></li>
                        <li class="py-1"><a href="">Promoções</a></li>
                    </ul>
                </div>
